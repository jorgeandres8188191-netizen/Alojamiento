...
namespace ut_presentacion.Aplicaciones
{
    ...
    {
        private readonly IAcompañantesAplicacion? iAplicacion;
        ...
        public AcompañantesPrueba()
        {
            ...
            iAplicacion = new AcompañantesAplicacion(iConexion);
        }
        [TestMethod]
        ...
        public bool Guardar()
        {
            ...
            this.entidad = EntidadesNucleo.Acompañantes(TelefonosAcompañantes)!;
