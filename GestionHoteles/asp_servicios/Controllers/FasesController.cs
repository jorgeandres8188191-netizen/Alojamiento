...
namespace asp_servicios.Controllers
{
    ...
    {
        private IFasesAplicacion? iAplicacion = null; private TokenController? tokenController = null;
        public FasesController(IFasesAplicacion? iAplicacion, TokenController tokenController) { this.iAplicacion = iAplicacion; this.tokenController = tokenController; }
        ...
        public string PorEstudiante()
        {
            ...
            {
                var datos = ObtenerDatos(); if (!tokenController!.Validate(datos)) { respuesta["Error"] = "lbNoAutenticacion"; return JsonConversor.ConvertirAString(respuesta); }
                var entidad = JsonConversor.ConvertirAObjeto<Fases>(JsonConversor.ConvertirAString(datos["Entidad"]));
