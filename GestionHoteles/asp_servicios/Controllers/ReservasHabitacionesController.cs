...
namespace asp_servicios.Controllers
{
    ...
    public class ReservasHabitacionesController : ControllerBase
    {
        private IReservasHabitacionesAplicacion? iAplicacion = null; private TokenController? tokenController = null;
        public ReservasHabitacionesController(IReservasHabitacionesAplicacion? iAplicacion, TokenController tokenController) { this.iAplicacion = iAplicacion; this.tokenController = tokenController; }
        ...
        public string PorEstudiante()
        {
            ...
            {
                var datos = ObtenerDatos(); if (!tokenController!.Validate(datos)) { respuesta["Error"] = "lbNoAutenticacion"; return JsonConversor.ConvertirAString(respuesta); }
                var entidad = JsonConversor.ConvertirAObjeto<ReservasHabitaciones>(JsonConversor.ConvertirAString(datos["Entidad"]));
