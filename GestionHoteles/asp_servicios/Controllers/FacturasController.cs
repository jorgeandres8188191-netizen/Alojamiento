...
namespace asp_servicios.Controllers
{
    ...
    {
        private IFacturasAplicacion? iAplicacion = null; private TokenController? tokenController = null;
        public FacturasController(IFacturasAplicacion? iAplicacion, TokenController tokenController) { this.iAplicacion = iAplicacion; this.tokenController = tokenController; }
        ...
        public string PorEstudiante()
        {
            ...
            {
                var datos = ObtenerDatos(); if (!tokenController!.Validate(datos)) { respuesta["Error"] = "lbNoAutenticacion"; return JsonConversor.ConvertirAString(respuesta); }
                var entidad = JsonConversor.ConvertirAObjeto<Facturas>(JsonConversor.ConvertirAString(datos["Entidad"]));
