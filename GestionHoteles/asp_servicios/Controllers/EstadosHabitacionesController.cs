...
namespace asp_servicios.Controllers
{
    ...
    public class EstadosHabitacionesController : ControllerBase
    {
        private IEstadosHabitacionesAplicacion? iAplicacion = null; private TokenController? tokenController = null;
        public EstadosHabitacionesController(IEstadosHabitacionesAplicacion? iAplicacion, TokenController tokenController) { this.iAplicacion = iAplicacion; this.tokenController = tokenController; }
        ...
        public string Guardar()
        {
            ...
            {
                var datos = ObtenerDatos(); if (!tokenController!.Validate(datos)) { respuesta["Error"] = "lbNoAutenticacion"; return JsonConversor.ConvertirAString(respuesta); }
                var entidad = JsonConversor.ConvertirAObjeto<EstadosHabitaciones>(JsonConversor.ConvertirAString(datos["Entidad"]));
