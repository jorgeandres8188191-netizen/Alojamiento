...
namespace asp_servicios.Controllers
{
    ...
    {
        private ITiposMascotasAplicacion? iAplicacion = null; private TokenController? tokenController = null;
        public TiposMascotasController(ITiposMascotasAplicacion? iAplicacion, TokenController tokenController) { this.iAplicacion = iAplicacion; this.tokenController = tokenController; }
        ...
        public string Guardar()
        {
            ...
            {
                var datos = ObtenerDatos(); if (!tokenController!.Validate(datos)) { respuesta["Error"] = "lbNoAutenticacion"; return JsonConversor.ConvertirAString(respuesta); }
                var entidad = JsonConversor.ConvertirAObjeto<TiposMascotas>(JsonConversor.ConvertirAString(datos["Entidad"]));
