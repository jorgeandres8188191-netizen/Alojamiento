...
namespace asp_servicios.Controllers
{
    ...
    {
        private ITiposHabitacionesAplicacion? iAplicacion = null; private TokenController? tokenController = null;
        public TiposHabitacionesController(ITiposHabitacionesAplicacion? iAplicacion, TokenController tokenController) { this.iAplicacion = iAplicacion; this.tokenController = tokenController; }
        ...
        public string PorEstudiante()
        {
            ...
            {
                var datos = ObtenerDatos(); if (!tokenController!.Validate(datos)) { respuesta["Error"] = "lbNoAutenticacion"; return JsonConversor.ConvertirAString(respuesta); }
                var entidad = JsonConversor.ConvertirAObjeto<TiposHabitaciones>(JsonConversor.ConvertirAString(datos["Entidad"]));
