...
namespace asp_servicios.Controllers
{
    ...
    public class TelefonosAcompañantesController : ControllerBase
    {
        private ITelefonosAcompañantesAplicacion? iAplicacion = null; private TokenController? tokenController = null;
        public TelefonosAcompañantesController(ITelefonosAcompañantesAplicacion? iAplicacion, TokenController tokenController) { this.iAplicacion = iAplicacion; this.tokenController = tokenController; }
        ...
        public string Guardar()
        {
            ...
            {
                var datos = ObtenerDatos(); if (!tokenController!.Validate(datos)) { respuesta["Error"] = "lbNoAutenticacion"; return JsonConversor.ConvertirAString(respuesta); }
                var entidad = JsonConversor.ConvertirAObjeto<TelefonosAcompañantes>(JsonConversor.ConvertirAString(datos["Entidad"]));
