    ...
    public class TokenController : ControllerBase
    {
        ...
        public string Autenticar()
        {
            var respuesta = new Dictionary<string, object>(); try
            {
                ...
                if (!datos.ContainsKey("Usuario") || datos["Usuario"].ToString()! != DatosGenerales.usuario_datos) { respuesta["Error"] = "lbNoAutenticacion"; 
            ...
            catch (Exception ex) { respuesta["Error"] = ex.ToString(); 
                return JsonConversor.ConvertirAString(respuesta); 
            }
        }
