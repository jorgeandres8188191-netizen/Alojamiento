...
namespace asp_servicios.Controllers
{
    ...
    public class EstadosFacturasController : ControllerBase
    {
        private IEstadosFacturasAplicacion? iAplicacion = null; private TokenController? tokenController = null;
        public EstadosFacturasController(IEstadosFacturasAplicacion? iAplicacion, TokenController tokenController) { this.iAplicacion = iAplicacion; this.tokenController = tokenController; }
        ...
        public string Guardar()
        {
            ...
            {
                var datos = ObtenerDatos(); if (!tokenController!.Validate(datos)) { respuesta["Error"] = "lbNoAutenticacion"; return JsonConversor.ConvertirAString(respuesta); }
                var entidad = JsonConversor.ConvertirAObjeto<EstadosFacturas>(JsonConversor.ConvertirAString(datos["Entidad"]));
